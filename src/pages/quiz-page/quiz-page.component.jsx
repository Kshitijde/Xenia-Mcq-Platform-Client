...
class QuizPage extends Component {
  ...
  componentDidMount() {
    ...
    var link="https://api.xeniamcq.co.in/c2c/getTime/"+this.props.match.params.authToken
    console.log(link)
    axios
    .post(link)
    .then((res) => {
  ...
  submit=(reference,response)=>{
    ...
    var link="https://api.xeniamcq.co.in/c2c/saveResponse/"+reference.props.match.params.authToken
    axios
      .post(link, response)
      .then(function (res) {
